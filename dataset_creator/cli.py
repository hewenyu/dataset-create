...
def generate_dataset(
    ...
    model: str = typer.Option("gpt-4", help="Model to use for generation"),
    provider: str = typer.Option("openai", help="Provider of the model"),
...
def fine_tune(
    ...
    provider: str = typer.Option("openai", help="Provider for fine-tuning"),
    ...
    # Create fine-tuner
    fine_tuner = ModelFineTuner(config=config)
